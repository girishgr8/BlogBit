...
if($temp!=""){
  ...
  for($r=0;$r<count($parts);$r++){
    $postIDS[]=$parts[$r]; 
    $list = explode('_', $parts[$r]);
    $usernames[]=$list[0];
    $titles[]=$list[1];  
    $images[]=$list[0].'_'.$list[1].'.png';

    $sql="SELECT disclaimer from blog where username='$list[0]' and title = '$list[1]'";
    $res=$conn->query($sql);
  ...
  <nav class="navbar navbar-default  navbar-expand-lg fixed-top ">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="./displaySavedBlogs.php" class="nav-item nav-link" title="Saved Posts"><img src="../images/save2.svg" class="icons highlight-icon"></a></li>
    ...
    <div class="container">
     <div class="posts" id="timeline"> 
      ...
      if($temp!=""){
        ...
        echo "<b style='font-size:20px; color:white;'>You do not have any saved blogs yet!</b>";
      }
